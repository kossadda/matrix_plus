...
TEST(InverseMatrixTest, Test_1) {
  ...
  double values1[] = {1.123, 4.534, 1.1235, 6.331, 7.77, 0.5345, 1.14,  4.66,
                      7.787, 4.11,  0.433,  4.565, 0.0,  3.42,   3.333, 1.534};
  matrix1.Fill(values1);

  S21Matrix expected(4, 4);
  double expected_values[] = {-0.1064846, 0.0388999,  0.1049608,  0.0089534,
                              -0.0102129, -0.2397261, 0.2406755,  0.0541702,
                              -0.0808835, 0.1852758,  -0.1732068, 0.2864256,
                              0.1985089,  0.1319027,  -0.1602426, -0.0912118};
